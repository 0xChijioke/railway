...
export type AllowedChainIds = (typeof raailConfig.targetNetworks)[number]["id"];
...
export const getAlchemyHttpUrl = (chainId: number) => {
  return raailConfig.alchemyApiKey && RPC_CHAIN_NAMES[chainId]
    ? `https://${RPC_CHAIN_NAMES[chainId]}.g.alchemy.com/v2/${raailConfig.alchemyApiKey}`
    : undefined;
};
...
export function getTargetNetworks(): ChainWithAttributes[] {
  return raailConfig.targetNetworks.map(targetNetwork => ({
    ...targetNetwork,
